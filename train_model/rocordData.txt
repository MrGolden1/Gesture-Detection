...
#define TIMER_COUNTER 500000
#define ACCEL_THRESHOLD 30000
...
void recordIMU()
{
    ...
    for (int i = 0; i < NUM_SAMPLES; i++)
    {
        ...
        features[i * NUM_AXES + 0] = accel_x;
        features[i * NUM_AXES + 1] = accel_y;
        features[i * NUM_AXES + 2] = accel_z;
...
{
    // Serial.println(abs(ax) + abs(ay) + abs(az));
...
void InitWiFi()
{
    String ssid = "MrGolden";
    String password = "tesla12345";
...
{ // When a WebSocket message is received
    ...
    case WStype_TEXT: // if new text data is received
        ...
        {
            Serial.println("Echoing back R");
            String data = String(accel_angle_x) + ',' + String(accel_angle_y) + ',' + String(accel_angle_z);
            webSocket.sendTXT(num, "data:" + data);
        }
        break;
    }
}
...
void loop()
{
    ...
    if (!motionDetected(accel_x, accel_y, accel_z))
    {
        delay(10);
        return;
    }
